...
bC=Button(root,padx=30,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='clear',bg='green').grid(row=1,column=3)
#Row2
...
#Row4
b_dot=Button(root,padx=35,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='.',bg='purple').grid(row=4,column=0)
b0=Button(root,padx=30,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='0').grid(row=4,column=1)
b_divison=Button(root,padx=35,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='/',bg='purple').grid(row=4,column=2)
b_multiply=Button(root,padx=65,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='*',bg='purple').grid(row=4,column=3)
#Row5

b_open_bracket=Button(root,padx=34,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='(',bg='purple').grid(row=5,column=0)
b_close_bracket=Button(root,padx=34,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text=')',bg='purple').grid(row=5,column=1)
b_equal=Button(root,padx=114,pady=15,bd=5,fg='black',font=('arial',30,'bold'),text='=',bg='green').grid(row=5,column=2,columnspan=2)
root.mainloop()